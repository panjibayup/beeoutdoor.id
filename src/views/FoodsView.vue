      ...
      <div class="row mt-3 daftar-makanan2" data-aos="fade-right" data-aos-duration="1500">
        <div class="col">
          <div class="input-group mb-3">
            <input v-model="search" type="text" class="form-control" placeholder="Cari barang Kamu..." aria-label="Cari" aria-describedby="basic-addon1" @keyup="searchFood" />
...
export default {
  ...
  methods: {
    ...
    searchFood() {
      axios
        .get("https://heliotrope-shade-hill.glitch.me//products?q=" + this.search)
  ...
  mounted() {
    axios
      .get("https://heliotrope-shade-hill.glitch.me//products")
      .then((response) => this.setProducts(response.data))
      .catch((error) => console.log(error));
  },
};
